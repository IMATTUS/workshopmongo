...
import com.imn.workshopmongo.dto.AuthorDTO;
import com.imn.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null,sdf.parse("21/03/2018"),"Partiu Viagem","Vou viajar pra Sampa, abraços!",new AuthorDTO(maria));
